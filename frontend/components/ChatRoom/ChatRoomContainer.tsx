...
const ChatRoomContainer: React.FC<ChatRoomContainerProps> = ({
  ...
  return (
    <div className="h-full flex flex-col relative">
      ...
      {/* Chat Container - No background, on top of background */}
      <div className="h-full flex flex-col relative" style={{ zIndex: 10, backgroundColor: 'transparent' }}>
        {/* Header */}
        ...
        <div className="flex-1 flex items-center gap-3">
          ...
          >
            ...
            <button
              ...
              title={t('chat.viewMembers') || 'View Members'}
            >
        ...
        <form onSubmit={handleSendMessage} className="flex gap-2">
          ...
          <div className="flex-1 relative">
            ...
            {showMentionDropdown && mentionUsers.length > 0 && (
              <div className="absolute bottom-full left-0 mb-1 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 max-h-48 overflow-y-auto z-50">
                {mentionUsers
      ...
      {showReportDialog && userToReport && (
        <ReportUserDialog
          ...
          contentType={roomData?.background_picture ? 'chat_background' : undefined}
          onClose={() => {
