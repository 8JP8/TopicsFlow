...
const TicketsModal: React.FC<TicketsModalProps> = ({ onClose }) => {
  ...
  }, [filterStatus, filterCategory, page, searchQuery]);
      ...
      if (response.data.success) {
        ...
        if (searchQuery) {
          ...
          ticketsData = ticketsData.filter((ticket: Ticket) =>
            ...
            (ticket.username && ticket.username.toLowerCase().includes(lowerQuery)) ||
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="relative w-full md:flex-1 md:max-w-md">
              <input
                ...
                className="w-full pl-10 pr-4 py-2 theme-bg-primary theme-border rounded-lg theme-text-primary text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
              />
