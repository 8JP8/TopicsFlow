...
const PWAInstallPrompt: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 z-50 animate-slide-up">
      <div className="bg-gradient-to-r from-blue-600 to-blue-500 rounded-lg shadow-2xl p-4 border-2 border-white/20">
          ...
          <div className="flex-1">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="px-4 py-2 bg-white text-blue-600 rounded-lg font-semibold text-xs hover:bg-white/90 transition-colors shadow-lg"
              >
                {t('pwa.install') || 'Install'}
              </button>
              <button
                onClick={handleDismiss}
                className="px-4 py-2 bg-white/20 text-white rounded-lg font-semibold text-xs hover:bg-white/30 transition-colors"
              >
