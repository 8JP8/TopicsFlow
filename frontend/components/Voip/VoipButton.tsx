        ...
        return (
            ...
            >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M21.23 18.06l-1.07-1.07c.36-.26.75-.48 1.15-.65-.63-.98-.9-2.09-.9-3.28 0-1.23.41-2.42 1.12-3.41l1.45 1.45c-.2.58-.32 1.25-.37 1.96H21.23z" />
                    <path d="M12 14c1.66 0 2.99-1.34 2.99-3 0-.55-.15-1.06-.41-1.5l1.49 1.49C16.03 11.3 16 11.64 16 12z" />
                    <path d="M3.27 4.54L2 5.81l2.45 2.45c-.93 1-1.45 2.22-1.45 3.51 0 1.66 1.34 3 3 3 .55 0 1.06-.15 1.5-.41L18.19 22l1.27-1.27L3.27 4.54z" />
                </svg>
            </button>
        );
    }
