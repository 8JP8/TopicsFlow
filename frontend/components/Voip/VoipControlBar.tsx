...
const VoipControlBar: React.FC = () => {
    ...
    return (
        <div className="theme-bg-secondary border-t theme-border">
            {/* Status Bar */}
            <div className="px-3 py-2 flex items-center justify-between border-b theme-border">
            ...
            {/* Controls */}
            <div className="px-3 py-2 flex items-center gap-2 border-t theme-border">
                {/* Mute Button */}
