...
export default function Document() {
  return (
    <Html lang="en" suppressHydrationWarning>
      <Head>
        <link rel="icon" type="image/png" sizes="48x48" href="/ícons/icon-48x48.png" />
        <link rel="icon" type="image/png" sizes="72x72" href="/ícons/icon-72x72.png" />
        <link rel="icon" type="image/png" sizes="96x96" href="/ícons/icon-96x96.png" />
        <link rel="icon" type="image/png" sizes="128x128" href="/ícons/icon-128x128.png" />
        <link rel="icon" type="image/png" sizes="144x144" href="/ícons/icon-144x144.png" />
        <link rel="icon" type="image/png" sizes="152x152" href="/ícons/icon-152x152.png" />
        <link rel="icon" type="image/png" sizes="192x192" href="/ícons/icon-192x192.png" />
        <link rel="icon" type="image/png" sizes="384x384" href="/ícons/icon-384x384.png" />
        <link rel="icon" type="image/png" sizes="512x512" href="/ícons/icon-512x512.png" />
        <link rel="apple-touch-icon" sizes="180x180" href="/ícons/icon-180x180.png" />
        <link rel="apple-touch-icon" sizes="1024x1024" href="/ícons/icon-1024x1024.png" />
        ...
        <meta property="og:image" content="https://topicsflow.me/ícons/banner.png" />
        ...
        <meta name="twitter:image" content="https://topicsflow.me/ícons/banner.png" />
