...
const LoginPage: React.FC = () => {
  ...
  const handleTOTPLogin = async (code: string) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/auth/login-passwordless`, {
        method: 'POST',
        ...
        <div className="w-full max-w-md">
          <div className="theme-bg-secondary rounded-2xl shadow-xl p-8 border theme-border">
            ...
            <div className="mt-6 space-y-3 text-center text-sm">
              <div>
                <a href="/recovery" className="text-blue-600 hover:text-blue-700 font-medium">
